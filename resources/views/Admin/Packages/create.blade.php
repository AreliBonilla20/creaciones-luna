...
<div class="main-wrapper">
    ...
    <form class="py-2 px-5" action="{{route('packages.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
        <select class="custom-select" name="section_id" id="section_id" value="{{old('section_id')}}">
